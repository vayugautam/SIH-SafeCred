      ...
      <nav className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 text-sm text-slate-600 md:flex">
            ...
            <Link href="#workflow" className="transition-colors hover:text-blue-600">Workflow</Link>
            <Link href="#contact" className="transition-colors hover:text-blue-600">Contact</Link>
          </div>

          <div className="flex items-center gap-3">
            <Link href="/login" className="hidden text-sm font-medium text-slate-600 transition-colors hover:text-blue-600 sm:block">
              Sign in
            </Link>
            <Link href="/register">
